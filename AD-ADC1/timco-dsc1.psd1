...
G_SysAdmins,Security,Global,"OU=SysAdmins,OU=Users,OU=Managed","CC1","Global group for SysAdmins"
G_AppAdmins,Security,Global,"OU=AppAdmins,OU=Users,OU=Managed","EE1","Global group for AppAdmins"
G_AppUsers,Security,Global,"OU=AppUsers,OU=Users,OU=Managed","AA1","Global group for AppUsers"
'@
    }
} 
